...
**TOAST는 개인 이미지 업로드를 지원하지 않습니다.**

### 퍼블릭 이미지

TOAST에서 제공하는 이미지입니다. 이 이미지들에는 가상 하드웨어를 최적으로 이용하도록 운영체제가 설치되어 있습니다. 또한 고객의 서비스와 애플리케이션에서 안심하고 사용할 수 있도록 기본적인 보안 설정이 되어 있습니다.

TOAST는 현재 CentOS, Debian, Ubuntu와 Windows를 제공하고 있습니다. 자세한 제공 운영체제 버전은 [토스트(TOAST) 서비스](https://gov.toast.com/service/compute/instance)를 참고합니다.
