...
**Compute > Image** 서비스 페이지에서 원하는 이미지를 선택한 후 **이미지 수정**을 클릭하여 이미지를 수정합니다. 수정 가능한 항목은 다음과 같습니다.
...
> [주의]
> 이미지 수정 시 연관 서비스 및 기능에 영향이 발생할 수 있습니다.

> [참고] 
> OS 구분은 변경할 수 없습니다.

> [참고] 
> 최소 메모리, 최소 블록 스토리지 값은 필수로 입력 해야 합니다.

## 삭제 보호 설정 변경

**Compute > Image** 서비스 페이지에서 원하는 이미지의 삭제 보호 아이콘을 클릭하거나 이미지를 선택한 후 **삭제 보호 설정 변경 > 삭제 보호 사용 > 확인**을 클릭하여 실수로 이미지를 삭제하는 것을 방지할 수 있습니다. 

삭제 보호를 설정한 이미지를 삭제하려면, 원하는 이미지의 삭제 보호 아이콘을 다시 클릭하거나 이미지를 선택한 후 **삭제 보호 설정 변경 > 삭제 보호 사용 안함 > 확인**을 클릭합니다.
