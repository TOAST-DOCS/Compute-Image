...
| limit | Query | Integer | - | 반환할 이미지 개수<br>기본값은 100, 최대 1000                                                                                                                                      |
...
!!! tip "알아두기"
    nhncloud_allow_download 속성이 false인 경우 [이미지 수정 API](./public-api-ngovc/#modify-image)를 통해 속성을 true로 변경할 수 있습니다.
