...
| 타입 | 리전 | 엔드포인트 |
|---|---|---|
| image | 한국(대구) 리전 | https://kr4-api-instance-infrastructure.ngovc.com |
...
!!! tip "알아두기"
    nhncloud_allow_download 속성이 false인 경우 [이미지 수정 API](./public-api-ngovc/#_17)를 통해 속성을 true로 변경할 수 있습니다.
